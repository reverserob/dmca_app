   ...
   <h1 class="page-heading">Prepare a DMCA Notice</h1>
    ...
    {!! Form::open(['method' => 'GET', 'action' => 'NoticesController@confirm']) !!}
       ...
       <div class="form-group">
           ...
           {!! Form::label('infringing_link','What is the link whre the content is located.') !!}
       ...
       <div class="form-group">
           ...
           {!! Form::label('original_link','To verify that you own the content, we now need the link to th original link on your server.') !!}
